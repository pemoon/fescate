...
$fescate_base_directory   = dirname(realpath($argv[0]));
...
if(!file_exists("$fescate_base_directory/PHP-Parser/composer.json"))
{
...
$t_composer             = json_decode(file_get_contents("$fescate_base_directory/PHP-Parser/composer.json"));   //print_r($t_composer);
