...
class Config
{
	...
	public $t_ignore_constants       = true;         // array where values are names to ignore.
	public $t_ignore_variables       = [
		'sitepress',
		'wp_rewrite',
		'wp_scripts',
		'wp_styles',
	...
	public $t_ignore_functions       = true;         // array where values are names to ignore.
	public $t_ignore_class_constants = true;         // array where values are names to ignore.
	public $t_ignore_methods         = true;         // array where values are names to ignore.
	public $t_ignore_properties      = true;         // array where values are names to ignore.
	public $t_ignore_classes         = true;         // array where values are names to ignore.
	public $t_ignore_interfaces      = true;         // array where values are names to ignore.
	public $t_ignore_traits          = true;         // array where values are names to ignore.
	public $t_ignore_namespaces      = true;         // array where values are names to ignore.
	...
	public $obfuscate_function_name       = false;         // self explanatory
	public $obfuscate_class_name          = false;         // self explanatory
	public $obfuscate_interface_name      = false;         // self explanatory
	public $obfuscate_trait_name          = false;         // self explanatory
	public $obfuscate_class_constant_name = false;         // self explanatory
	public $obfuscate_property_name       = false;         // self explanatory
	public $obfuscate_method_name         = false;         // self explanatory
	public $obfuscate_namespace_name      = false;         // self explanatory
	...
	{
		global $fescate_version;
		$now = strftime("%F %T");

		return sprintf($this->comment, $fescate_version, $now);
	}
